class PostsController < ApplicationController
  ...
  def index
    @posts = Post.order("id DESC")
     ...
     set_page_keywords ('一家三口,寵物安親,寵物美容,寵物住宿,寵物,狗狗,貓咪,狗貓夜間急診,24小時動物醫院')
  end
  ...
  def show
    @post = Post.find(params[:id])
     ...
     set_page_keywords ('一家三口,寵物安親,寵物美容,寵物住宿,狗狗,貓咪,寵物,狗貓夜間急診,24小時動物醫院')
  end
  ...
  def about
    ...
    set_page_keywords ('寵物安親,寵物美容,寵物住宿,狗狗,貓咪,寵物,狗貓夜間急診,24小時動物醫院')
  end
