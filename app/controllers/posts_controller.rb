class PostsController < ApplicationController
  ...
  def daycare
    ...
    set_page_description ("一家三口動物旅館安親服務，一家三口動物旅館秉持著貼心、溫暖、像家。")
    set_page_keywords ('一家三口,安親,美容,住宿,寵物,daycare')
  end

  def grooming
    set_page_title "美容Grooming"
    set_page_description ("一家三口動物旅館美容服務，專業的美容師，讓寶貝們更有自信。")
    set_page_keywords ('一家三口,安親,美容,住宿,寵物,Grooming')
  end

  def hotel
    set_page_title "住宿Hotel"
    set_page_description ("一家三口動物旅館住宿服務，安全、像家、但是擁有更多同伴。")
    set_page_keywords ('一家三口,安親,美容,住宿,寵物,hotel')
  end

  def about
    set_page_title "關於我們about us"
    set_page_description ("一家三口動物旅館成立於2015年10月，位於桃園市桃園區民生路上，一家三口是一間安全、健康、溫暖的動物旅館，在這裡我們提供美容、住宿、及安親的服務。")
